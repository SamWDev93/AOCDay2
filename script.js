...
//   if (cleanInput[i].direction == "forward") {
//     submarine.position += cleanInput[i].num;
//   } else if (cleanInput[i].direction == "down") {
//     submarine.depth += cleanInput[i].num;
//   } else {
//     submarine.depth -= cleanInput[i].num;
//   }
// }
...
for (let i = 0; i < cleanInput.length; i++) {
  if (cleanInput[i].direction == "forward") {
    submarine.position += cleanInput[i].num;
    submarine.depth += submarine.aim * cleanInput[i].num;
  } else if (cleanInput[i].direction == "down") {
    submarine.aim += cleanInput[i].num;
  } else {
    submarine.aim -= cleanInput[i].num;
  }
}
